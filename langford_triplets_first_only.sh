...
do
	...
	echo 3 1 $N1 0 12 | ./langford_solver
	echo "Triplets first only 2 $N1"
	echo 3 2 $N1 0 12 | ./langford_solver
	echo "Triplets first only 1 $N2"
	echo 3 1 $N2 0 12 | ./langford_solver
	echo "Triplets first only 2 $N2"
	echo 3 2 $N2 0 12 | ./langford_solver
	echo "Triplets first only 1 $N3"
	echo 3 1 $N3 0 12 | ./langford_solver
	echo "Triplets first only 2 $N3"
	echo 3 2 $N3 0 12 | ./langford_solver
	let N1=$((N1+9))
	let N2=$((N2+9))
	let N3=$((N3+9))
done
